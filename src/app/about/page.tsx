...
export default function About() {
  ...
  return (
    <div
      className={`${pageTheme} min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white relative overflow-hidden`}
    >
      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-4 sm:px-6 py-24 pt-32 min-h-screen lg:ml-2 pt-20">
